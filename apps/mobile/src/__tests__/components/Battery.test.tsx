...
describe("Battery Component", () => {
  test("displays correct color and size for high battery", () => {
    ...
    expect(batteryFill.style.width).toBe(`${Math.round(Math.floor((75 * 23) / 100))}px`);
  });
  ...
  test("displays correct color and size for medium battery", () => {
    ...
    expect(batteryFill.style.width).toBe(`${Math.round(Math.floor((35 * 23) / 100))}px`);
  ...
  test("displays correct color and size for low battery", () => {
    ...
    expect(batteryFill.style.width).toBe(`${Math.round(Math.floor((15 * 23) / 100))}px`);
  });
});
