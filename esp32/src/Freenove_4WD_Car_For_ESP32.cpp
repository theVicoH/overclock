  ...
  {
    float distance = 0;
    int wheal_tour_second = 10;
    int wheal_diameter = 5;
    distance = wheal_tour_second * wheal_diameter;

    return distance; // retourne la distance parcouru en temps réél du véhicule
  }